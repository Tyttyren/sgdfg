...
plate_path = 'D:\soft\python\python_project\lenet\img_file\img_3.png'
root_path = 'D:\soft\python\python_project\lenet'
MIN_PALAT_AREA = 6000
...
def readjpg():
    ...
    print(f'round_width:{img_resize_width}, round_height:{img_resize_height}')
